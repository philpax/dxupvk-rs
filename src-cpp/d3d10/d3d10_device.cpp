...
namespace dxvk {
  ...
  HRESULT STDMETHODCALLTYPE D3D10Device::CreateBuffer(
    ...
    *ppBuffer = new D3D10Buffer(d3d11Buffer, this);
    return S_OK;
  }
  ...
  HRESULT STDMETHODCALLTYPE D3D10Device::CreateTexture1D(
    ...
    *ppTexture1D = new D3D10Texture1D(d3d11Texture1D, this);
    return S_OK;
  }
  ...
  HRESULT STDMETHODCALLTYPE D3D10Device::CreateTexture2D(
    ...
    *ppTexture2D = new D3D10Texture2D(d3d11Texture2D, this);
    return S_OK;
  }
  ...
  HRESULT STDMETHODCALLTYPE D3D10Device::CreateTexture3D(
    ...
    *ppTexture3D = new D3D10Texture3D(d3d11Texture3D, this);
    return S_OK;
  }
  ...
  HRESULT STDMETHODCALLTYPE D3D10Device::CreateShaderResourceView(
    ...
    *ppSRView = new D3D10ShaderResourceView(d3d11Srv, this);
    return S_OK;
  }
  ...
  HRESULT STDMETHODCALLTYPE D3D10Device::CreateShaderResourceView1(
    ...
    *ppSRView = new D3D10ShaderResourceView(d3d11View, this);
    return S_OK;
  }
  ...
  HRESULT STDMETHODCALLTYPE D3D10Device::CreateRenderTargetView(
    ...
    *ppRTView = new D3D10RenderTargetView(d3d11View, this);
    return S_OK;
  }
  ...
  HRESULT STDMETHODCALLTYPE D3D10Device::CreateDepthStencilView(
    ...
    *ppDepthStencilView = new D3D10DepthStencilView(d3d11View, this);
    return S_OK;
  }
  ...
  HRESULT STDMETHODCALLTYPE D3D10Device::CreateInputLayout(
    ...
    *ppInputLayout = new D3D10InputLayout(d3d11InputLayout, this);
    return hr;
  }
  ...
  HRESULT STDMETHODCALLTYPE D3D10Device::CreateVertexShader(
    ...
    *ppVertexShader = new D3D10VertexShader(d3d11Shader, this);
    return S_OK;
  }
  ...
  HRESULT STDMETHODCALLTYPE D3D10Device::CreateGeometryShader(
    ...
    *ppGeometryShader = new D3D10GeometryShader(d3d11Shader, this);
    return S_OK;
  }
  ...
  HRESULT STDMETHODCALLTYPE D3D10Device::CreatePixelShader(
    ...
    *ppPixelShader = new D3D10PixelShader(d3d11Shader, this);
    return S_OK;
  }
  ...
  HRESULT STDMETHODCALLTYPE D3D10Device::CreateBlendState(
    ...
    *ppBlendState = new D3D10BlendState(d3d11BlendState, this);
    return S_OK;
  }
  ...
  HRESULT STDMETHODCALLTYPE D3D10Device::CreateDepthStencilState(
    ...
    *ppDepthStencilState = new D3D10DepthStencilState(d3d11DepthStencilState, this);
    return S_OK;
  }
  ...
  HRESULT STDMETHODCALLTYPE D3D10Device::CreateRasterizerState(
    ...
    *ppRasterizerState = new D3D10RasterizerState(d3d11RasterizerState, this);
    return S_OK;
  }
  ...
  HRESULT STDMETHODCALLTYPE D3D10Device::CreateSamplerState(
    ...
    *ppSamplerState = new D3D10SamplerState(d3d11SamplerState, this);
    return S_OK;
  }
  ...
  HRESULT STDMETHODCALLTYPE D3D10Device::CreateQuery(
    ...
    *ppQuery = new D3D10Query(d3d11Query, this);
     return S_OK;
  }
  ...
  HRESULT STDMETHODCALLTYPE D3D10Device::CreatePredicate(
    ...
    *ppPredicate = new D3D10Query(d3d11Predicate, this);
    return S_OK;
  }
  ...
  void STDMETHODCALLTYPE D3D10Device::ClearRenderTargetView(
    ...
    ID3D11RenderTargetView* d3d11View = d3d10View ? d3d10View->GetD3D11Iface() : nullptr;
  ...
  void STDMETHODCALLTYPE D3D10Device::ClearDepthStencilView(
    ...
    ID3D11DepthStencilView* d3d11View = d3d10View ? d3d10View->GetD3D11Iface() : nullptr;
  ...
  void STDMETHODCALLTYPE D3D10Device::SetPredication(
    ...
    ID3D11Query* d3d11Predicate = d3d10Predicate ? d3d10Predicate->GetD3D11Iface() : nullptr;

    m_context->SetPredication(static_cast<ID3D11Predicate*>(d3d11Predicate), PredicateValue);
  }
  ...
  void STDMETHODCALLTYPE D3D10Device::GetPredication(
    ...
    if (ppPredicate)
      *ppPredicate = d3d11Predicate ? LookupFromD3D11<ID3D10Predicate, ID3D11Predicate>(d3d11Predicate) : nullptr;
  }
  ...
  void STDMETHODCALLTYPE D3D10Device::GenerateMips(
    ...
    ID3D11ShaderResourceView* d3d11View = d3d10View ? d3d10View->GetD3D11Iface() : nullptr;
  ...
  void STDMETHODCALLTYPE D3D10Device::IASetInputLayout(
    ...
    ID3D11InputLayout* d3d11InputLayout = d3d10InputLayout ? d3d10InputLayout->GetD3D11Iface() : nullptr;
  ...
  void STDMETHODCALLTYPE D3D10Device::IASetIndexBuffer(
    ...
    ID3D11Buffer* d3d11Buffer = d3d10Buffer ? d3d10Buffer->GetD3D11Iface() : nullptr;
  ...
  void STDMETHODCALLTYPE D3D10Device::IAGetInputLayout(
    ...
    *ppInputLayout = d3d11InputLayout
      ? LookupFromD3D11<ID3D10InputLayout, ID3D11InputLayout>(d3d11InputLayout)
      : nullptr;
  }
    ...
    if (ppVertexBuffers) {
      for (uint32_t i = 0; i < NumBuffers; i++) {
        ppVertexBuffers[i] = d3d11Buffers[i]
          ? LookupFromD3D11<ID3D10Buffer, ID3D11Buffer>(d3d11Buffers[i])
          : nullptr;
      }
    }
  }
  ...
  void STDMETHODCALLTYPE D3D10Device::IAGetIndexBuffer(
    ...
    if (pIndexBuffer)
      *pIndexBuffer = d3d11Buffer ? LookupFromD3D11<ID3D10Buffer, ID3D11Buffer>(d3d11Buffer) : nullptr;
  }
  ...
  void STDMETHODCALLTYPE D3D10Device::VSSetShader(
    ...
    ID3D11VertexShader* d3d11Shader = d3d10Shader ? d3d10Shader->GetD3D11Iface() : nullptr;
  ...
  void STDMETHODCALLTYPE D3D10Device::VSGetShader(
    ...
    *ppVertexShader = d3d11Shader ? LookupFromD3D11<ID3D10VertexShader>(d3d11Shader) : nullptr;
  }
  ...
  void STDMETHODCALLTYPE D3D10Device::VSGetConstantBuffers(
    ...
    for (uint32_t i = 0; i < NumBuffers; i++) {
      ppConstantBuffers[i] = d3d11Buffers[i]
        ? LookupFromD3D11<D3D10Buffer>(d3d11Buffers[i])
        : nullptr;
    }
  }
  ...
  void STDMETHODCALLTYPE D3D10Device::VSGetShaderResources(
    ...
    for (uint32_t i = 0; i < NumViews; i++) {
      ppShaderResourceViews[i] = d3d11Views[i]
        ? LookupFromD3D11<D3D10ShaderResourceView>(d3d11Views[i])
        : nullptr;
    }
  }
  ...
  void STDMETHODCALLTYPE D3D10Device::VSGetSamplers(
    ...
    for (uint32_t i = 0; i < NumSamplers; i++) {
      ppSamplers[i] = d3d11Samplers[i]
        ? LookupFromD3D11<D3D10SamplerState>(d3d11Samplers[i])
        : nullptr;
    }
  }
  ...
  void STDMETHODCALLTYPE D3D10Device::GSSetShader(
    ...
    ID3D11GeometryShader* d3d11Shader = d3d10Shader ? d3d10Shader->GetD3D11Iface() : nullptr;
  ...
  void STDMETHODCALLTYPE D3D10Device::GSGetShader(
    ...
    *ppGeometryShader = d3d11Shader ? LookupFromD3D11<ID3D10GeometryShader>(d3d11Shader) : nullptr;
  }
  ...
  void STDMETHODCALLTYPE D3D10Device::PSSetShader(
    ...
    ID3D11PixelShader* d3d11Shader = d3d10Shader ? d3d10Shader->GetD3D11Iface() : nullptr;
  ...
  void STDMETHODCALLTYPE D3D10Device::PSGetShader(
    ...
    *ppPixelShader = d3d11Shader ? LookupFromD3D11<D3D10PixelShader>(d3d11Shader) : nullptr;
  }
  ...
  void STDMETHODCALLTYPE D3D10Device::OMSetRenderTargets(
    ...
    ID3D11DepthStencilView* d3d11Dsv = d3d10Dsv ? d3d10Dsv->GetD3D11Iface() : nullptr;
  ...
  void STDMETHODCALLTYPE D3D10Device::OMSetBlendState(
    ...
    ID3D11BlendState* d3d11BlendState = d3d10BlendState ? d3d10BlendState->GetD3D11Iface() : nullptr;
  ...
  void STDMETHODCALLTYPE D3D10Device::OMSetDepthStencilState(
    ...
    ID3D11DepthStencilState* d3d11DepthStencilState = d3d10DepthStencilState ? d3d10DepthStencilState->GetD3D11Iface() : nullptr;
    ...
    if (ppRenderTargetViews != nullptr) {
      for (uint32_t i = 0; i < NumViews; i++) {
        ppRenderTargetViews[i] = d3d11Rtv[i]
          ? LookupFromD3D11<D3D10RenderTargetView>(d3d11Rtv[i])
          : nullptr;
      }
    }

    if (ppDepthStencilView)
      *ppDepthStencilView = d3d11Dsv ? LookupFromD3D11<D3D10DepthStencilView>(d3d11Dsv) : nullptr;
  }
  ...
  void STDMETHODCALLTYPE D3D10Device::OMGetBlendState(
    ...
    if (ppBlendState != nullptr)
      *ppBlendState = d3d11BlendState ? LookupFromD3D11<D3D10BlendState>(d3d11BlendState) : nullptr;
  }
  ...
  void STDMETHODCALLTYPE D3D10Device::OMGetDepthStencilState(
    ...
    if (ppDepthStencilState != nullptr)
      *ppDepthStencilState = d3d11DepthStencilState ? LookupFromD3D11<D3D10DepthStencilState>(d3d11DepthStencilState) : nullptr;
  }
  ...
  void STDMETHODCALLTYPE D3D10Device::RSSetState(
    ...
    ID3D11RasterizerState* d3d11RasterizerState = d3d10RasterizerState ? d3d10RasterizerState->GetD3D11Iface() : nullptr;
  ...
  void STDMETHODCALLTYPE D3D10Device::RSGetState(
    ...
    *ppRasterizerState = d3d11RasterizerState ? LookupFromD3D11<D3D10RasterizerState>(d3d11RasterizerState) : nullptr;
  }
